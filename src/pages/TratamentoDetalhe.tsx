        ...
        <ScrollReveal className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-border">
          ...
          <div className="mt-12 pt-12 border-t text-center space-y-6">
            ...
            <ScheduleDialog>
              <Button
                size="lg"
                className="rounded-full py-4 sm:py-3 px-8 bg-[#25D366] hover:bg-[#128C7E] text-white flex items-center justify-center gap-2 text-center text-base cursor-pointer w-full sm:w-auto mx-auto h-auto whitespace-normal"
              >
